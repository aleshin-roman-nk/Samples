...
namespace LivingRectangles
{
    public class FlatColors
    {
        ...
        public static Color CellBorder = ColorTranslator.FromHtml("#6b705c");
        public static Color CellBackground = ColorTranslator.FromHtml("#ffe8d6");
        public static Color SelectedCellBorder = ColorTranslator.FromHtml("#ee9b00");
        public static Color DayHeaderBack = ColorTranslator.FromHtml("#fdffb6");
        public static Color SelectedDayBorder = ColorTranslator.FromHtml("#a4ac86");
